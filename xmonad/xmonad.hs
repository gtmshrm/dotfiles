...
main = do
  ...
  xmonad $ docks $ ewmh myBaseConfig
    ...
    , handleEventHook    = handleEventHook myBaseConfig <+> fullscreenEventHook -- hitesh's
...
myLayout = avoidStruts (
    ...
    noBorders Full |||
    spiral (6/7)) --- ||| --- gautam's comment
--    noBorders (fullscreenFull Full)  --- gautam's comment
--
--myLayout = avoidStrutsOn [U] ( --- hitesh's
--    Tall 1 (3/100) (1/2) |||
--    Mirror (Tall 1 (3/100) (1/2)) |||
--    spiral (16/9)  |||
--    Grid(16/10) ||| 
